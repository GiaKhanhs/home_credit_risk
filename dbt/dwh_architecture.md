...
| Mart | Final dataset for analysis | Customer-level dataset |
...
| **Mart (Gold)**                                 | `int_*`                                                    | `mart_application_train`, `mart_application_test`                                                                                                                                                                     | Join all features into customer-level dataset                                                 | Final analytical dataset |
